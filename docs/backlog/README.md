...
| [ISSUE-008](file:///mnt/GG/VSCodeProjects/CustomModManagerWarhammer3/docs/backlog/issues/ISSUE-008-true-dom-virtualization.md) | **Sliding-Window True DOM Virtualization Engine** | **P1 - High** | **Phase 2** | S2 (Major) | `ModList` / `VirtualScroller` | 3–4 hours |

*Merged / Superseded References*:
- [ISSUE-002](file:///mnt/GG/VSCodeProjects/CustomModManagerWarhammer3/docs/backlog/issues/ISSUE-002-mod-list-virtualization-and-content-skipping.md) $\rightarrow$ *CSS Virtualization superseded by [ISSUE-008](file:///mnt/GG/VSCodeProjects/CustomModManagerWarhammer3/docs/backlog/issues/ISSUE-008-true-dom-virtualization.md) (Sliding-Window True DOM Virtualization)*.
